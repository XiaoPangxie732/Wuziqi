...
//    private final PrepareMatchPacket.Action action;
//    private final BlockPos boardPos;
//
//    public ServerboundPrepareMatchPacket(PrepareMatchPacket.Action action, BlockPos boardPos) {
//        this.action = action;
...
//        return new ServerboundPrepareMatchPacket(buf.readEnum(PrepareMatchPacket.Action.class), buf.readBlockPos());
//    }
//
//}