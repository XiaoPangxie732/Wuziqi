...
//    private final PiecePacket.Action action;
//    private final byte x;
//    private final byte z;
//
//    public ServerboundPiecePacket(BlockPos pos, PiecePacket.Action action, byte x, byte z) {
//        this.pos = pos;
//        this.action = action;
//        this.x = x;
//        this.z = z;
...
//        return new ServerboundPiecePacket(buf.readBlockPos(), buf.readEnum(PiecePacket.Action.class), buf.readByte(), buf.readByte());
//    }
//
//}